          ...
          {ProcessData.map((process) => {
            return (
              <div className={style.card}>
                <div className={style.leftCornerElement}></div>
                <div className={style.topCornerElement}></div>
                <div className={style.rightCornerElement}></div>
                <div className={style.bottomCornerElement}></div>
